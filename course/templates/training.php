...
<center>
<div  style="margin: 0 200px;"><b>Follow the slides below answering all questions and noting key terms and examples. For more information and sources, click "notes" in the slides.</b></div>
</center><br>
<center>
<button type="button" class="btn btn-primary btn-block" style="pointer-events: none;">Section 1: Introduction to HIPAA</button>
</center><br>
<center>
<!--<iframe src="https://gtvault-my.sharepoint.com/personal/afargason3_gatech_edu/_layouts/15/Doc.aspx?sourcedoc={a3dc680b-55c5-499a-98e9-34bbe1a470b1}&amp;action=embedview&amp;wdAr=1.7777777777777777" width="952px" height="576px" frameborder="0">This is an embedded <a target="_blank" href="https://office.com">Microsoft Office</a> presentation, powered by <a target="_blank" href="https://office.com/webapps">Office</a>.</iframe>-->
<iframe src="https://gtvault-my.sharepoint.com/personal/afargason3_gatech_edu/_layouts/15/Doc.aspx?sourcedoc={a3dc680b-55c5-499a-98e9-34bbe1a470b1}&amp;action=embedview&amp;wdAr=1.7777777777777777" width="952px" height="576px" frameborder="0">This is an embedded <a target="_blank" href="https://office.com">Microsoft Office</a> presentation, powered by <a target="_blank" href="https://office.com/webapps">Office</a>.</iframe>        
</center><br>
<center>
<div  style="margin: 0 200px;"> <b> In this section you learned the definition of a "Covered Entity" and a "Business Associate". Section 2 will cover the basics of HIPAA rules. Please complete the following knowledge check before you continue.</b></div><br>
</center>
<center>

<h2>A Pharmacy Benefits Manager is considered a:</h2>
...
<div class="form-check" style="text-align: left;">
  <input class="form-check-input" type="radio" name="Q1" id="A3" checked>
  <label class="form-check-label" for="flexRadio">
    Neither - Excempt from HIPAA Rules
  </label>
</div>
</div><br>

<button type="button" onclick="getscore()">Submit</button><br><br><br>
...
<a id="next" style="display:none" href="section2" class="btn btn-info" role="button">Next</a>
        </center>
...
<script>
    function getscore() {
        if (document.getElementById("A2").checked) {
            ...
            localStorage.setItem("progresswidth", "10");
            const progresswidth = localStorage.getItem("progresswidth");
